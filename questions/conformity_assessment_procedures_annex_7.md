# Questions - Conformity Assessment Procedures - Annex 7
...
-  **Purpose and Scope of EU-Type Examination**:  Are you aware that the EU-type examination will assess both:
    - the **technical design and development** of the product with digital elements, and
    - the **vulnerability handling processes** you have put in place?
- **Meeting the essential cybersecurity requirements**: Can you demonstrate that your product meets the **essential cybersecurity requirements** in:
	- **Part I of Annex I** (product requirements), and (check questions)
	- **Part II of Annex I** (vulnerability handling process requirements)? (check questions)
...
- **Technical documentation**: The **technical documentation**  (check questions) enabling assessment against Annex I requirements, including: 
	- design, manufacturing, and operation details
	- risk analysis and assessment
	- all elements required by **Annex VII**, where applicable?
- **Supporting evidence**: **Supporting evidence** demonstrating adequacy of the design and vulnerability handling processes, including:
...
- **Requirement for Additional Approval (“Additions”)**: Do you obtain **additional approval** (an “addition” to the certificate) for such modifications (in the form of an EU-type examination certificate)?
- **Periodic Audits**: Are you aware that the notified body conducts **periodic audits** to ensure that vulnerability handling processes (Annex I, Part II) remain adequately implemented?
...
- Do your products satisfy all the **essential cybersecurity requirements** in:
	- **Part I of Annex I** (product requirements), and (check questions)
	- **Part II of Annex I** (manufacturer process requirements)? (check questions)
- **Conformity of production**: Have you taken all necessary measures to ensure that **production and production monitoring** keep the manufactured products fully conformant with:
...
- **Availability of DoC**: Do you keep the Declaration of Conformity **available to national authorities** for:
	- at least **10 years** after the product is placed on the market, or
	- for the **support period**, whichever is longer?
 - **Request from Authorities**: Can you provide a **copy of the Declaration of Conformity** to authorities upon request?
 - **Authorized representative fulfiling manufacturer obligations**: If you have appointed an authorised representative, does the mandate **explicitly specify** that they may fulfil the manufacturer’s obligations underCE marking & the questions above?
...
- **Decision notification**: Regarding the above the notified body will notify you of the decision ( or the authorized representative ) with the conclusions of the audit and the reasoned assessment decision.
-  **Commitment to Maintain the Quality System**: Have you committed to maintain and continuously apply the approved quality system so it remains adequate and effective?
- **Notification of Quality System Changes**: Are you aware that you need inform the notified body of any intended changes to your quality system, and do you obtain approval before applying them?
-  **Surveillance Access & Cooperation**: Do you provide the notified body with full access during surveillance audits, including to:
	- design, development, production, testing, and storage sites,
	- all quality system documentation
